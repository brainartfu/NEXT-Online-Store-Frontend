...
const TotalSalesChart = ({ TotalSalesData }: { TotalSalesData: TotalSalesDataProps }) => {
					...
					<Box sx={{ flexGrow: 1, display: "flex", alignItems: "center", gap: 2.5, mt: -2 }}>
						<Stack spacing={1}>
							<Typography
								variant="h5"
								fontWeight="bold"
								sx={{ opacity: 0.7, color: TotalSalesData.titleColor }}
							>
								{TotalSalesData.title}
							</Typography>
